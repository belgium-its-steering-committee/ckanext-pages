        ...
        editor.widgets.add('collapsibleItem', {
            ...
            editables: {
                ...
                content: {
                    ...
                    allowedContent: 'p;h1;h2;h3;h4;br;span(*)[*];ul[style];ol[style];li[style];strong;b;em;u;table{background-color;color};tbody;thead;tr{background-color;color};td{background-color;color};th{background-color;color};hr;a;a[*];a(*)[*];img(*)[*];'
                }
            },
