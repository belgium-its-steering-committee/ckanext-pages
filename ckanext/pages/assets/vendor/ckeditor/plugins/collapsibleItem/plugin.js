function getCollapsibleItem() {
    var collapsibleItem =
        ...
        '           <a data-info="test div"class="collapsed collapsible-item-title-link-icon pull-right" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseCollapbsible" aria-expanded="false" aria-controls="collapseCollapbsible"><span><i class="fa fa-arrow-down"></i>&nbsp;</span></a>' +
        ...
        editor.widgets.add('collapsibleItem', {
            ...
            editables: {
                ...
                content: {
                    ...
                    allowedContent: 'i(*)[*];p;h1;h2;h3;h4;br;span(*)[*]ul;ol;li;strong;em;u;table(*)[*];tbody;thead;tr;td;th;hr;a;a[*];a(*)[*];img(*)[*];*{color};*{size}'
                }
            },
            allowedContent: 'div(!collapsible-item*,panel*,collapse)[*];h4(!collapsible-item*,panel*)[*];a(!collapsible-item*,collapsed,panel*)[*];span(*)[*];i(*)[*]',
