function getCollapsibleItem() {
    var collapsibleItem =
        ...
        '           <a class="collapsed collapsible-item-title-link-icon pull-right" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseCollapbsible" aria-expanded="false" aria-controls="collapseCollapbsible"><i class="icon-arrow-down"></i><span class="glyphicon">&nbsp;</span></a>' +
...
CKEDITOR.plugins.add('collapsibleItem', {
    ...
    init: function (editor) {
        editor.widgets.add('collapsibleItem', {
            ...
            allowedContent: 'div(!collapsible-item*,panel*,collapse)[*];h4(!collapsible-item*,panel*)[*];a(!collapsible-item*,collapsed,panel*)[*];i(*)[*];span(!glyphicon*)[*];',
